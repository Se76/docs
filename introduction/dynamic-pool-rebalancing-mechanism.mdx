...
<Info>
  Assets are reallocated from high-risk pools to low-risk pools to stabilize
  liquidity.
</Info>
...
<CardGroup cols={2}>
  <Card
    title="Higher APY for low-utilization pools to attract deposits"
    icon={
      <svg
  ...
  ></Card>
  <Card
    title="Increased fees for high-risk pools to deter excessive borrowing"
    icon={
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="28"
...
<Card
  title="If VaR exceeds predefined safety limits"
  icon={
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="28"
...
>
  S-Five triggers a cool-down mechanism, restricting new deposits into high-risk
  pools.
</Card>
