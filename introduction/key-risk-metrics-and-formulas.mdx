...
<CardGroup cols={3}>
  ...
  <Card
    title="Optimal utilization (50-80%)"
    icon={
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="28"
...
<Card
  title="Identifies borrowers at risk of liquidation due to market volatility."
  icon={
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="28"
...
></Card>
<Card
  title="Safe Utilization Threshold is typically set at 70-80%."
  icon={
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="28"
...
<Card
  title="Ensures liquidity reserves align with potential market movements."
  icon={
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="28"
...
<CardGroup cols={2}>
  <Card
    title="Higher borrow usage = greater liquidation sensitivity"
    icon={
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="28"
  ...
  ></Card>
  <Card
    title="Used to determine capital efficiency and adjust pool weights dynamically."
    icon={
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="28"
