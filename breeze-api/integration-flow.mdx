...
<Info>
  This represents one possible implementation approach. Your implementation may
...
<Card
  title="Create Strategy & Get API Key"
  href="/customer-portal/create-strategy"
  icon="rocket"
>
  Before starting, create a strategy in the Customer Portal and get your API
  key.
</Card>
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="window"
    href="/integration-guide/breeze-ui-components-integration-example"
  >
